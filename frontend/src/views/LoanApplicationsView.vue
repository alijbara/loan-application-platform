...
<template>
  <section class="max-w-7xl mx-auto p-6 dark:text-gray-100 h-[calc(100vh-60px)] overflow-x-auto">
    <h2 class="text-3xl text-center text-white font-semibold mb-6">Loan Applications</h2>
